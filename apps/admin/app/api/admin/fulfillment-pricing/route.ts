...
const TABLE = 'fulfillment_tiers';
const COLS = ['name', 'rate_percent', 'description', 'features', 'is_popular', 'sort_order', 'is_active'];
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error('[/api/admin/fulfillment-pricing]', message);
